...
const FooterLayer = () => {
  ...
  return (
    <div className="foot-container" id="contact">
      <div className="foot">
        ...
        <div className="programs-offer">
          ...
          <p>
            <a class="footer-link" href="tel: +250-788-473-533">
              +250-788-473-533
            </a>
            <br />
            <a class="footer-link" href="mailto:igirerwanda@gmail.com">
        ...
        <div className="programs-offer">
          ...
          <ul>
            <li>
              <a href="#">Igire Rwanda organisation</a>
            </li>
            <li>
              <a href="#">TekCODE</a>
            </li>
